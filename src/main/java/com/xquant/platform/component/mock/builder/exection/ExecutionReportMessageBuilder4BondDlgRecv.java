...
@Component
public class ExecutionReportMessageBuilder4BondDlgRecv
		implements IMockMessageInfoBuilder4ExcutionReport<CfetsTradeExecutionReportMessage, CfetsTradeBondDialogueQuoteResMessage> {
	...
	public boolean matches(Class<?> cls, OpTypeEnum optype) {
		return CfetsTradeBondDialogueQuoteResMessage.class.equals(cls) && OpTypeEnum.BOND_DIALOGUE_CONFIRM.equals(optype);
	}

	@SuppressWarnings({ "rawtypes", "unchecked" })
	@Override
	public MockMessageInfo build(CfetsTradeExecutionReportMessage messageTempldate, CfetsTradeBondDialogueQuoteResMessage originMessage,

...
@Component
public class ExecutionReportMessageBuilder4BondReplyRecv
		implements IMockMessageInfoBuilder4ExcutionReport<CfetsTradeExecutionReportMessage, CfetsTradeBondRFQReplyResMessage> {
	...
	public boolean matches(Class<?> cls, OpTypeEnum optype) {
		return CfetsTradeBondRFQReplyResMessage.class.equals(cls) && OpTypeEnum.BOND_RFQREPLY_CONFIRM.equals(optype);
	}

	@SuppressWarnings({ "rawtypes", "unchecked" })
	@Override
	public MockMessageInfo build(CfetsTradeExecutionReportMessage messageTempldate, CfetsTradeBondRFQReplyResMessage originMessage,

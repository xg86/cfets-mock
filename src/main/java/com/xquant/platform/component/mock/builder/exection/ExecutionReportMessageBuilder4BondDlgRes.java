...
@Component
public class ExecutionReportMessageBuilder4BondDlgRes
		implements IMockMessageInfoBuilder4ExcutionReport<CfetsTradeExecutionReportMessage, CfetsTradeBondDialogueQuoteReplyResMessage> {
	...
	public boolean matches(Class<?> cls, OpTypeEnum optype) {
		return CfetsTradeBondDialogueQuoteReplyResMessage.class.equals(cls) && OpTypeEnum.BOND_DIALOGUE_CONFIRM.equals(optype);
	}

	@SuppressWarnings({ "rawtypes", "unchecked" })
	@Override
	public MockMessageInfo build(CfetsTradeExecutionReportMessage messageTempldate, CfetsTradeBondDialogueQuoteReplyResMessage originMessage,

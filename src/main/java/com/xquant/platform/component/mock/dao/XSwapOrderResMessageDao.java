...
@Repository
public interface XSwapOrderResMessageDao {
	 ...
	 * @return
	 */
	public int insert(XSwapOrderResBody message);
	 ...
	 * @return
	 */
	public XSwapOrderResBody queryByQuoteId(@Param("quoteId") String quoteId);
}

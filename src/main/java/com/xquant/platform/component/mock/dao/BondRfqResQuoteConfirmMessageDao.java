...
@Repository
public interface BondRfqResQuoteConfirmMessageDao {
	 ...
	 * @return
	 */
	public int insert(CfetsTradeBondRFQReplyConfirmResMessageBody message);
	 ...
	 * @return
	 */
	public CfetsTradeBondRFQReplyConfirmResMessageBody queryByQuoteId(@Param("quoteId") String quoteId);
}

...
public class MyXswapChannelGroup {
	
	
	private static Logger logger = LoggerFactory.getLogger(MyXswapChannelGroup.class);

	private static ChannelGroup CHANNEL_GROUP = new DefaultChannelGroup("XSWAP_CHANNEL_GROUP", GlobalEventExecutor.INSTANCE);

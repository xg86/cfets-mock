...
@Component
public class ExecutionReportMessageBuilder4PledgeBondRecv
		implements IMockMessageInfoBuilder4ExcutionReport<CfetsTradeExecutionReportMessage, CfetsTradeCollateralDialogueQuoteResMessage> {
	...
	public boolean matches(Class<?> cls, OpTypeEnum optype) {
		return CfetsTradeCollateralDialogueQuoteResMessage.class.equals(cls) && OpTypeEnum.PLEDGEREPO_DIALOGUE_CONFIRM.equals(optype);
	}

	@SuppressWarnings({ "rawtypes", "unchecked" })
	@Override
	public MockMessageInfo build(CfetsTradeExecutionReportMessage messageTempldate, CfetsTradeCollateralDialogueQuoteResMessage originMessage,

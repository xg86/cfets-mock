 ...
 * @date: 2018-08-20 08:33:37
 * 本方新增请求回复报价
 */
@Component
public class BondReplyResMessageAddInfoBuilder extends AbstartCfetsMessageInfoBuilder<CfetsTradeBondRFQReplyResMessage> {
	...
	public void fillWithCompute(ComputeService computeService, CfetsTradeBondRFQReplyResMessage message) {
		fillWithCompute4RfqReply(computeService, message.getBody());
	}
